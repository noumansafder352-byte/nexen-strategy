  ...
  return (
    ...
    >
      ...
      >
        <span
          className={[
            "flex h-12 items-center justify-center gap-2 rounded-full bg-gradient-to-r from-[#FFA53C] to-[#FF483F] px-0 text-white shadow-[0_10px_30px_-12px_rgba(255,72,63,0.6)] ring-1 ring-white/10 transition-all duration-300 ease-out will-change-transform md:h-14 md:pl-3 md:pr-5 hover:-translate-y-0.5 hover:brightness-110 hover:shadow-xl motion-reduce:transition-none",
            "translate-y-0 opacity-100",
          ].join(" ")}
        >
          <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-white/10 ring-1 ring-white/15 md:h-11 md:w-11">
